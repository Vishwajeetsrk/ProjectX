          ...
          <div className="pt-10 border-t-4 border-dashed border-black/10 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 -mt-8">
              ...
              <button
                ...
                disabled={loading}
                className="flex flex-col items-center justify-center gap-2 p-4 border-4 border-black font-black text-[10px] uppercase hover:bg-blue-50 transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1"
              >
