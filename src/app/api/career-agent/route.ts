...
const SYSTEM_PROMPT = `You are "AI Career Agent" — a world-class career intelligence system. Your job is to guide users toward REAL, LEGAL, HIGH-INCOME careers using structured, actionable, and market-driven insights specifically for the Indian market (2026 context).
...
STRICT JSON FORMAT: Return ONLY this structure:
{
  ...
  "roles": [{ "title": "Role", "salary": "Range", "demand": "High/Med", "skills": [] }],
  "roadmapNodes": [],
  "jobLinks": [
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ 
      reply: "I'm having trouble connecting. Ensure your project has space and try again!",
